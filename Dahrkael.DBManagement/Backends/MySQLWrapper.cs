...
namespace Dahrkael.DBManagement.Backends
{
    class MySQLWrapper
    {
        ...
        /// </summary>
        public MySQLWrapper() : this("127.0.0.1", "") // FIXME this should be something, not empty
        {
        ...
        public MySQLWrapper(string server, string database) : this("SYSDBA", "masterkey", server, 3306, database)
        {
        ...
        /// </summary>
        public MySQLWrapper(string userID, string userPass, string server, int port, string database)
        {
        ...
        /// <param name="connection"></param>
        public void CloseConnection(MySqlDataReader dataReader, MySqlConnection connection)
        {
            try
            {
                if (dataReader != null)
